...
let
    ...
    for distortion in [2.0, 0.0]
        ns, results100 = cos_2t_press_hyperboloid_fixed_examples.test_convergence(FEMMShellQ4RSModule, 1/100, distortion)
        ns, results1000 = cos_2t_press_hyperboloid_fixed_examples.test_convergence(FEMMShellQ4RSModule, 1/1000, distortion)
        ns, results10000 = cos_2t_press_hyperboloid_fixed_examples.test_convergence(FEMMShellQ4RSModule, 1/10000, distortion)
        ns, results100000 = cos_2t_press_hyperboloid_fixed_examples.test_convergence(FEMMShellQ4RSModule, 1/100000, distortion)
