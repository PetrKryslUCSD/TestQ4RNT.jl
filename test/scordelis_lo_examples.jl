...
# Abaqus, STRI3 elements, at regular mesh 64, 128, 256
q1 = 0.2997
q2 = 0.3003
q3 = 0.3005
@show qtrue = (q2^2 - q1 * q3) / (2 * q2 - q1 - q3) # 0.3006

# Abaqus, S4 elements, regular mesh 64, 128, 256
q1 = 0.3018
q2 = 0.301976
q3 = 0.302021
...
# [ Info: Solution: -3.01378e-01, 9.96622e+01%
# [ Info: Solution: -3.01441e-01, 9.96828e+01%
q1, q2, q3 = [9.95907e+01, 9.96622e+01, 9.96828e+01]

qtrue = (((q2 ^ 2 - q1 * q3) / ((2q2 - q1) - q3)) * 3.02400e-01) / 100 # = 3.01466e-01
