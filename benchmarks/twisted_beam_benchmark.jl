...
function _execute(t = 0.32, force = 1.0, dir = 3, nL = 24, nW = 2, bench_sol = 0.0, visualize = false)
    ...
    loaded = selectelem(fens, bfes, box = Float64[L L -Inf Inf -Inf Inf], inflate = tolerance)
...
using .Main.twisted_beam_benchmark; 
all_results = Main.twisted_beam_benchmark.test_convergence()
let
